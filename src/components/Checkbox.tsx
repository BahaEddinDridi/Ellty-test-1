...
const Checkbox: React.FC<CheckboxProps> = ({ label }) => {
  ...
  return (
    <label className="flex bg-white items-center justify-between w-[370px] h-[42px] px-[15px] pr-[10px] py-[8px] cursor-pointer group">
      <span
        className="
      ...
      <div className="p-[6px]">
        <span
          className={`w-[23px] h-[23px] rounded-[6px] border flex items-center 
    justify-center ${
      checked
